...
public interface SysUserService extends IService<SysUser> {
     ...
     * @date 2022/4/22 15:53
     **/
    String updateAvatar(UploadedFile file);
     ...
     * @date 2022/8/8 13:16
     **/
    void downloadImportUserTemplate(Context response) throws IOException;
     ...
     * @date 2022/8/8 13:16
     */
    JSONObject importUser(UploadedFile file);
     ...
     * @date 2022/8/8 13:16
     **/
    void exportUser(SysUserExportParam sysUserExportParam, Context ctx) throws IOException;
     ...
     * @date 2022/8/8 13:16
     **/
    void exportUserInfo(SysUserIdParam sysUserIdParam, Context response) throws IOException;
