...
public interface GenBasicService extends IService<GenBasic> {
     ...
     **/
    void execGenZip(GenBasicIdParam genBasicIdParam, Context response) throws IOException;
     ...
     * @date 2022/10/28 9:37
     **/
    void execGenPro(GenBasicIdParam genBasicIdParam, Context response) throws IOException;
